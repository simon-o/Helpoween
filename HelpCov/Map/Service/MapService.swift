...
protocol MapServiceProtocol: AnyObject {
    func addValue(name: String ,location: CLLocationCoordinate2D, address: String, getCandy: Bool, getVegan: Bool, getHalal: Bool, completion: @escaping ((Result<Void, Error>) -> Void))
